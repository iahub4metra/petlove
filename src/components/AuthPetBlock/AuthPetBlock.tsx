...
export default function AuhtPetBlock() {
    ...
    return (
        <div className="relative rounded-[30px] md:rounded-[60px] shrink-0 xl:h-[654px] bg-[#F6B83D] recktangle bg-[url(/images/Rectangle.png)] bg-no-repeat bg-bottom-right bg-size-[300px_241px] md:bg-size-[528px_251px] md:bg-position-[125px_bottom] xl:w-[592px] xl:bg-[url(/images/bg-pet-desc.png)] xl:bg-size-[512px_598px] xl:bg-position-[center_bottom]">
            <picture>
                <source
