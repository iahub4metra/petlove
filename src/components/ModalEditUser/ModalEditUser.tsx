...
export default function ModalEditUser() {
    ...
    const editUserStatus = useSelector(selectAuthOperations).editUser;
    const editUserError = useErrorBanner(
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        if (editUserStatus.status === 'succeeded') {
            ...
            >
                <div className="bg-white rounded-[30px] max-w-[335px] md:max-w-[480px] top-2/4 left-3/6 translate-[-50%] relative py-10 px-5 md:p-[50px]">
                    <button
                        ...
                        className="border-0 cursor-pointer bg-transparent hover:scale-[105%] transition-all hover:rotate-180 absolute top-[20px] right-[20px]"
                    >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button
                            type="submit"
                            loading={editUserStatus.status === 'loading'}
                            sx={{
                                borderRadius: '30px',
                                color: 'white',
                                fontSize: '14px',
